...
- (void)viewWillAppear:(BOOL)animated {
    ...
    JKFeedbackInfo* feedbackInfoObject = [[JKFeedbackInfo alloc] initWithApplogoImage:[UIImage imageNamed:@"IMG_20150929_220147.jpg"] andAppName:@"Sample app" andFeedbackViewBackgorundColor:[UIColor colorWithRed:0.5 green:0.6 blue:0.2 alpha:0.5]];
